...
NSString *KEY_TEXTURE_SHADOW = @"shadow";
...
NSString *KEY_TEXTURE_TUTORIAL_FLOOR = @"tutorial_floor";
NSString *KEY_TEXTURE_TUTORIAL_WALL = @"tutorial_wall";
...
- (void)loadTextures {
    ...
    texture = [[Texture alloc] initWithFilename:@"shadow.png"];
    [textures setObject:texture forKey:KEY_TEXTURE_SHADOW];
    ...
    texture = [[Texture alloc] initWithFilename:@"tutorial_floor.png"];
    [textures setObject:texture forKey:KEY_TEXTURE_TUTORIAL_FLOOR];
    texture = [[Texture alloc] initWithFilename:@"tutorial_wall.png"];
    [textures setObject:texture forKey:KEY_TEXTURE_TUTORIAL_WALL];
