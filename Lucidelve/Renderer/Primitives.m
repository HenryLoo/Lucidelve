...
+ (Mesh *)triangle {
	...
	NSMutableData *textureCoords = [NSMutableData data];
	...
	GLKVector3 v[] = {
		...
		GLKVector3Make(0.5f, -0.5f, 0.0f),
		GLKVector3Make(0.0f, 0.5f, 0.0f)
	};
	
	GLKVector2 vt[] = {
		GLKVector2Make(0.0f, 1.0f),
		GLKVector2Make(1.0f, 1.0f),
		GLKVector2Make(0.5f, 0.0f)
	};
    ...
    for (int i = 0; i < sizeof(v) / sizeof(GLKVector3); i++) {
        [vertices appendBytes:&v[i] length:sizeof(GLKVector3)];
    }
    
    for (int i = 0; i < sizeof(vt) / sizeof(GLKVector2); i++) {
        [textureCoords appendBytes:&vt[i] length:sizeof(GLKVector2)];
    }
    
    for (int i = 0; i < sizeof(vn) / sizeof(GLKVector3); i++) {
        [normals appendBytes:&vn[i] length:sizeof(GLKVector3)];
    }
    
    for (int i = 0; i < sizeof(ind) / sizeof(GLuint); i++) {
        [indices appendBytes:&ind[i] length:sizeof(GLuint)];
    }
